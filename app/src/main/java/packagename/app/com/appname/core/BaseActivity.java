...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    /**
     * The usage of this method is not allowed when using BaseActivity,
     * because this base implementation already inflates a layout with a toolbar.
     * Override method getLayoutResourceId() to inflate your custom activity
     * layout within the BaseActivity's container.
     * <p/>
